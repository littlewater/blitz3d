...
static int __finite( double n ){		// definition: exponent anything but 2047.
...
static int __isnan(double n){		// definition: exponent 2047, nonzero fraction.
